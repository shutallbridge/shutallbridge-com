...
import automationLevels from "./automation-levels.png";
import spreadsheetSop from "./spreadsheet-sop.png";
...
<Callout.TitleSlot slot="title">
  Email and Knowledge Assistant
</Callout.TitleSlot>

<Callout.DefaultSlot>
<Prose>

An assistant to highlight critical emails, draft replies, organize tasks and answer questions based on general back-office knowledge and knowledge from past emails and internal files.

- Strengths
  - **Wide Market Coverage**: Across back office functions, communication friction and knowledge management are shared pain points.
- Weaknesses
  - **Incremental Value Add**: Assisting with emails and knowledge management might be convenient, but it won’t directly increase capacity or reduce complexity.
  - **Unclear User Need**: Communication friction in particular was not the most prominent pain point and it’s unclear how it would differ from general office and productivity tools with AI features.
...
- Strengths
  - **Clear ROI**: Automating one high-impact workflow can directly increase capacity and enable BPOs to meet tight deadlines.
...
<Callout.TitleSlot title="title">Level 1</Callout.TitleSlot>

<Callout.DefaultSlot>
<Prose>

- **Remove Grunt Work**: Automate all repetitive invoice processing tasks, such as collecting invoices from email or SharePoint and converting files into PDF format.
- **Information Extraction**: Accurately extract key invoice data into a structured format, regardless of layout differences or handwritten content.
- **Draft Entry**: Automatically create invoice entries in the accounting system, eliminating manual data entry tasks like typing invoice numbers or vendor names.
...
<Callout.TitleSlot title="title">Level 2</Callout.TitleSlot>

<Callout.DefaultSlot>
<Prose>

- Includes all capabilities from Level 1
- **Enhanced Accuracy**: Improve extraction accuracy and expand support to more complex fields that require accounting knowledge, such as handling accruals and prepaid expense amortizations under GAAP standards.
...
<Callout.TitleSlot title="title">Level 3</Callout.TitleSlot>

<Callout.DefaultSlot>
<Prose>

- Includes all capabilities from Levels 1 and 2
- **Confidence in Accuracy**: Assess and flag whether an invoice entry is accurate or requires human review, enabling safe automation with minimal oversight.
