...
<div slot="content-header" class="flex justify-center px-6">
  <Bento.Root layout="sydney5">
    ...
    <Bento.Item class="bg-fuchsia-200 overflow-clip relative">
      <div class="w-[620px] h-auto absolute top-0 right-0 mt-6 mr-6">
        <Image src={tileCSide} alt="" />
      </div>
    </Bento.Item>
    <Bento.Item class="bg-fuchsia-200 overflow-clip relative @container">
      <div class="w-[620px] h-auto mt-6 absolute top-0 left-0 ml-6 @min-[calc(496px+200px)]:static @min-[calc(496px+200px)]:mx-auto">
